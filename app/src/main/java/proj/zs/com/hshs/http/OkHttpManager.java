...
public class OkHttpManager {
   ...
   private Gson mGson;
    ...
    public void postJsonRequest(String url, String jsonRequest, final BaseCallBack callBack) {
        Request request = buildJsonRequest(url, jsonRequest, HttpMethodType.POST);
        doRequest(request, callBack);
    }
    ...
    //异步下载文件
    public void asynDownloadFile(final String name, final String url, final String destFileDir, final BaseCallBack callBack) {
        final Request request = buildRequest(url, null, HttpMethodType.GET);
        callBack.OnRequestBefore(request);  //提示加载框
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            @Override
            public void onFailure(Call call, IOException e) {
                Log.d("IS-----IS","is是"+e.getMessage());
            ...
            public void onResponse(Call call, Response response) throws IOException {
                ...
                Log.d("文件大小","fileLength"+fileLength);
                int len = 0;
                long readLength = 0;
                ...
                try {
                    ...
                    while ((len = is.read(buf)) != -1) {
                        ...
                        Log.d("lgz", "onResponse: 正在请求中" + curProgress + ", readLength = " + readLength + ", fileLength = " + fileLength);
    ...
    //创建 Request对象
    private Request buildJsonRequest(String url, String json, HttpMethodType methodType) {
        ...
        if (methodType == HttpMethodType.GET) {
            ...
            RequestBody requestBody = buildJsonData(json);
            builder.post(requestBody);
        }
        return builder.build();
    }
...
//        builder.add("key", "123456");
     ...
     * @return
     */
    private RequestBody buildJsonData(String json){
...
//    public void postRequest(String url, BaseCallBack callBack) {
//        Request request = buildRequest(url, params, HttpMethodType.POST);
//        doRequest(request, callBack);
//    }
